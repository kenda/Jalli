...
/**
 * This is the main class of Jalli. It handles the prompted arguments and calls
...
public class Jalli {
    ...
    // main-method
    /**
     * The main method reads the given arguments and calls the relevant methods.
     * 
    ...
    public static void main(String[] args) {
        ...
        if(args.length < 3) {
            System.out
                    .println("Usage: java -jar Jalli-<version>.jar <Input> <Output> <InputFile(s)>\nSee readme for more informations.");
            System.exit(0);
        }
        ...
        switch(args[0].hashCode()) {
            case 880537848:
                new MCabber().readInputFile(filenames);
                break;
            case -1624392372:
                new Empathy().readInputFile(filenames);
                break;
            case -988451231:
                new Pidgin().readInputFile(filenames);
                break;
            default:
        ...
        switch(args[1].hashCode()) {
            case 880537848:
                new MCabber().writeOutputFile();
                break;
            case -1624392372:
                new Empathy().writeOutputFile();
                break;
            case -988451231:
                new Pidgin().writeOutputFile();
                break;
            default:
                System.out.println("Illegal argument");
                System.exit(1);
