...
/**
 * Here are all messages stored in a list. You can get access by using the
 * singleton instance.
 **/
public class Cache {
    ...
    /**
     * The number of messages with the same dates. More details: @see
     * calcNumberMessagesSameDate()
     **/
    private int numberMessagesSameDate = 0;

    /**
     * The number of how many different dates we have in our messages. More
     * details: @see calcDifferentDates()
     **/
    private int diffDates = 0;

    /**
     * The single instance of the cache. Use the getter to get access to the
     * cache.
     **/
    ...
    // service-methods
    /**
     * This is the method to work with the Singleton Cache. So we can't
     * instantiate a second cache.
     * 
    ...
    /**
     * This method calculates the number of messages with the SAME date. This is
     * important because e.g. mcabber saves all data in one single file and so
     * we have to extract the different dates. The relevant number is set to
     * 
    ...
    public void calcNumberMessagesSameDate() {
        ...
        if(this.messages.size() == 1)
            ...
            for(int i = 0; i < this.messages.size() - 1; i++) {
                if(this.messages.get(i).date
                        .equals(this.messages.get(i + 1).date))
                    count++;
                else
                    break;
            }
    ...
    /**
     * This method calculates how many different dates we have. This is
     * important, to know how many different files we have to create. The
     * relevant number is set to
     * 
     * @see #diffDates
     */
     ...
     * 
     * @return number of all messages in the list or rather the size of the list
     */
     ...
     * @return message at the specified position in the list
     */
    ...
    /**
     * Removes the message at the specified position in the list.
     * 
     * @param pos position of the message in the list
     */
    ...
    /**
     * Adds the message at the specified position in the list.
     * 
