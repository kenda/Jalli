...
/**
 * This is the abstract class of all sub-messengers. Normally there are only the
 * two methods for read-in and write-out
 */
public abstract class Messenger {
    ...
    /**
     * reads the input file, seperates the important information and adds this
     * to the cache.
     * 
    ...
    /**
     * reads the necessary data from the cache and writes it to the new logfile
     */
